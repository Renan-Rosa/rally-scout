...
import { SignUpForm } from "@/components/featured/auth/sign-up-form";
      ...
      <aside className='relative hidden flex-col justify-between overflow-hidden border-r border-white/10 px-10 py-10 lg:flex'>
        ...
        <div>
          ...
          >
            COMECE
            <br />
            <span className='text-[#ff751f]'>SUA JORNADA.</span>
          </h1>
          <p className='mt-8 max-w-sm text-xs leading-relaxed text-white/55'>
            Crie sua conta para montar elencos, registrar partidas e transformar
            cada rally em decisão.
          </p>
        </div>
